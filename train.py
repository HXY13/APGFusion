...
# from net import Restormer_Encoder, Restormer_Decoder, BaseFeatureExtraction_Fusion, DetailFeatureExtraction
...
# data loader
trainloader = DataLoader(H5Dataset(r"data/MSRS_trainMIF_new_imgsize_128_stride_200.h5"),
...
for epoch in range(num_epochs):
    ...
    for i, (data_VIS, data_IR) in enumerate(loader['train']):
        ...
        if epoch < epoch_gap: #Phase I
            ...
            # print("feature_I_B+feature_V_B",(feature_I_B+feature_V_B).shape) # torch.Size([8, 64, 128, 128])
...
if True:
    ...
    torch.save(checkpoint, os.path.join("models/APGFusion"+timestamp+'.pth'))
